    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('delivery_status', models.CharField(choices=[('Delivered', 'Delivered'), ('In Transit', 'In Transit'), ('Shipped', 'Shipped'), ('Out For Delivery', 'Out For Delivery')], max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('_id', models.AutoField(editable=False, primary_key=True, serialize=False)),
                ('delivery', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='products.delivery')),
        ...
        migrations.AddField(
            model_name='order',
            name='taxPrice',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='products.tax'),
        ),
        migrations.AddField(
            model_name='order',
            name='user',
